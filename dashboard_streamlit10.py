...
if (
    ...
    timeslot_panel, overall_panel = st.columns(
        [2.2, 1],
        gap="large"
    )

    # =====================================================
    # LEFT PANEL: TIME-SLOT-WISE MAPE
    # =====================================================
    ...
    with timeslot_panel:
        ...
        with st.container(border=True):
            ...
            st.plotly_chart(
                ...
                width="stretch",
                key="timeslot_2hr_mape_first_row",
                config={
                    "displayModeBar": False,
                    "staticPlot": True,
                    "responsive": True
    ...
    # =====================================================
    # RIGHT PANEL: OVERALL MAPE DISTRIBUTION
    # =====================================================
            ...
            if overall_information["total"] > 0:
                ...
                overall_pie_figure = (
                    create_mape_distribution_pie(
                        ...
                        period_title="Overall MAPE Distribution",
                ...
                st.plotly_chart(
                    overall_pie_figure,
                    width="stretch",
                    key="overall_2hr_mape_first_row",
                    config={
                        "displayModeBar": False,
                        "staticPlot": True,
                        "responsive": True
    ...
    # =====================================================
    # SECOND ROW: MORNING, NOON AND EVENING
    # =====================================================

    morning_panel, noon_panel, evening_panel = st.columns(
        3,
        gap="large"
    )
    ...
    period_chart_settings = [
        (
            morning_panel,
            "Morning",
            "morning_2hr_mape_second_row"
        ),
        (
            noon_panel,
            "Noon",
            "noon_2hr_mape_second_row"
        ),
        (
            evening_panel,
            "Evening",
            "evening_2hr_mape_second_row"
        )
    ]
